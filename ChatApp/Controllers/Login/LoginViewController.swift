                      ...
                      if(success){
                          ...
                          if (user.profile!.hasImage){
                              ...
                              URLSession.shared.dataTask(with: url) { data, res, error in
                                  ...
                                  StorageManager.shared.uploadMediaToStorage(with: data, uploadType: .profileImages, fileName: chatUser.profilePictureName) { result in
                                      switch result {
                    ...
                    DatabaseManager.shared.insertUser(with: fbUser){success in
                        if(success){
                            ...
                            URLSession.shared.dataTask(with: url) { data, res, error in
                                ...
                                StorageManager.shared.uploadMediaToStorage(with: data, uploadType: .profileImages, fileName: fbUser.profilePictureName) { result in
                                    switch result{
